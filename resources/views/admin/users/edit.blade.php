...
<div class="container">
  <div class="row justify-content-center">
    <div class="col-md-8">
      ...
      <div class="card">
        <div class="card-body">
          <form method="POST" action="{{ route('admin.user.edit-profile', $admin->admin_name) }}">
            @csrf
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                <input id="admin_name" type="text" class="form-control @error('admin_name') is-invalid @enderror"
                  name="admin_name" value="{{ old('admin_name', $admin->admin_name) }}" autocomplete="admin_name"
                  autofocus>
              ...
              <div class="col-md-6">
                <div class="input-group">
                  <input id="last_name" type="text" class="form-control @error('last_name') is-invalid @enderror"
                    name="last_name" value="{{ old('last_name', $admin->last_name) }}" placeholder="姓"
                    autocomplete="last_name">
                  <input id="first_name" type="text" class="form-control @error('first_name') is-invalid @enderror"
                    name="first_name" value="{{ old('first_name', $admin->first_name) }}" placeholder="名"
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                <input id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="email"
                  value="{{ old('email', $admin->email) }}" placeholder="mail@example.com" autocomplete="email">
